...
import Utility.SHA1
import Utility.SHA224
import Utility.SHA384
# 工具类，存放hash方法
...
class _Hash(_Singleton):
    ...
    def __init__(self): 
        ...
        self.sha1 = Utility.SHA1._SHA1()
        self.sha224 = Utility.SHA224._SHA224()
        self.sha384 = Utility.SHA384._SHA384()
    ...
    def Hash_Function(self, value, size, type=""):
        ...
        if type == "MD5":
            ...
            result_10 = int(self.sha1.SHA1_Hash(value_str), 16)
        elif type == "SHA224":
            result_10 = int(self.sha224.SHA224_Hash(value_str), 16)
        elif type == "SHA384":
            result_10 = int(self.sha384.SHA384_Hash(value_str), 16)
